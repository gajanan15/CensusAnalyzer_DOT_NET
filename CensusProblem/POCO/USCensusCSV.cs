   ...
   public class USCensusCSV
    {
        ...
        public USCensusCSV(string stateId, string stateName, string population, string housingUnits, string totalArea, string waterArea, string landArea, string populationDensity, string housingDensity)
        {
